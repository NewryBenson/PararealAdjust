...
void RK2(rhs RHS, double* u, double* u_sol, double* u_temp, double dt, size_t N, bool GPU)
{
    ...
    RHS(u_sol, k2, GPU);                             //* k2 = RHS(u + k1) = RHS(u_sol) 
